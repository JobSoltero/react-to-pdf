  ...
  _createClass(ReactToPdf, [{
    ...
    value: function toPdf() {
      var _props = this.props,
          ...
          optionsCanvas = _props.optionsCanvas,
          onComplete = _props.onComplete,
          customSave = _props.customSave;
      ...
      (0, _html2canvas2.default)(targetComponent, _extends({ logging: false, useCORS: true }, optionsCanvas)).then(function (canvas) {
